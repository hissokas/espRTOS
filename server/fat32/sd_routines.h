...
//use following macros if SS (4) pin is used for Chip Select of SD
#define MMC_CS_PIN	4 //IO
#define SD_CS_ASSERT     GPIO_OUTPUT_SET(MMC_CS_PIN, 0)
#define SD_CS_DEASSERT   GPIO_OUTPUT_SET(MMC_CS_PIN, 1)
